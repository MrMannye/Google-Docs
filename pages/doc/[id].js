    ...
    return (
        <div>
            <header className='flex justify-between items-center p-3 pb-1'>
                ...
                <div className='flex-grow px-2 text-base'>
                    <h2 className='ml-1'>{snapshot?.data()?.fileName}</h2>
                    <div className='flex items-center text-xs space-x-1 h-8 text-gray-600'>
                ...
                buuttonType='filled'
                size='regular'
                className='hidden md:!inline-flex h-10 transition duration-300 ease-out'
                rounded={false}
                block={false}
                iconOnly={false}
                ripple='light'
